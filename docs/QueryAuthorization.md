...
Version **5.0.1.1** backports query authorization to **5.0.0.5**. It retains
the .NET 10 target and existing runtime dependencies, including Blazorise 1.8.6
for `PGMS.BlazorComponents`; it does not include the 5.1 migration to Blazorise 2.
